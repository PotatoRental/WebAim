...
/*UserAccount*/
  ...
  INSERT INTO UserAccount(username, password, email, firstName, lastName) VALUES ('eeval', 'password', 'eeval@aim.com', 'Evan', 'Eval');
  INSERT INTO UserAccount(username, password, email, firstName, lastName) VALUES ('cic', 'password', 'cic@aim.com', 'Candi', 'Icol');
  INSERT INTO UserAccount(username, password, email, firstName, lastName) VALUES ('milky', 'test', 'milky@aim.com', 'Im', 'Adin');
